...
const sampleMessages: ChatMessage[] = [
  { id: '1', from: 'them', text: 'Hi Peter! Do u want 2 come 2 the cinema tonight?' },
  { id: '2', from: 'me', text: 'Hi! Sure, what time?' },
  { id: '3', from: 'them', text: '7:30 PM okay?' },
  { id: '4', from: 'me', text: 'Perfect! See you then.' },
];
