...
const EditProfileScreen = () => {
  ...
  // Sync form data when profileData changes from context
  useEffect(() => {
  ...
  const handleCancel = () => {
    setFormData(profileData); // Reset to original data from context
    setIsEditing(false);
  };
  ...
  const renderField = (label: string, field: keyof ProfileData, placeholder: string, multiline = false) => (
