    ...
    if (selectedBarberData) {
      ...
      router.push({
        ...
        params: {
          ...
          selectedServiceLabel: selectedServiceLabel || 'ASAP Appointment',
          // Use selected services if available, otherwise fallback to default
          selectedServicesJson: selectedServicesJson || JSON.stringify([
            {
              key: 'hair',
