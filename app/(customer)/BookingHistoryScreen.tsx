...
import BookAgainModal from '../../components/BookAgainModal';
...
export default function BookingHistoryScreen() {
  ...
  useEffect(() => {
    if (params.reopenModal === 'true' && params.selectedBookingId) {
      const booking = mockBookings.find(b => b.id === params.selectedBookingId);
      if (booking) {
        setSelectedBooking(booking);
        setShowBookAgainModal(true);
      }
    }
  }, [params.reopenModal, params.selectedBookingId]);
  ...
  return (
    <>
                  ...
                  <TouchableOpacity 
                    ...
                    onPress={() => router.push({
                      ...
                      params: {
                        ...
                        salonImage: booking.image,
                        barberName: booking.barberName,
                        barberImage: booking.image,
      ...
      {selectedBooking && (
        <BookAgainModal
          visible={showBookAgainModal}
          onClose={handleCloseModal}
          bookingData={selectedBooking}
          initialStep={params.reopenModal === 'true' ? 'datetime' : 'services'}
        />
      )}
    </View>
    </>
